window.js_beautify = function (js_source_text, indent_size, indent_character, indent_level) {
    ...
    line_starters = 'continue,try,throw,return,var,if,switch,case,default,for,while,break'.split(',');
            ...
            case 'TK_START_BLOCK':
                ...
                if (last_type !== 'TK_OPERATOR' && last_type !== 'TK_START_EXPR') {
                    if (last_type === 'TK_START_BLOCK') {
                        ...
                        if (!(output[output.length - 1] === "$" && token_text == "{")) {
                            print_space();
                        }
                    }
                }
            ...
            case 'TK_WORD':
                ...
                if (token_text === 'case' || token_text === 'default') {
                    if (last_text === ':') {
                        ...
                        unindent();
                        if (!(output.length && output[output.length - 1] === "export")) {
                            print_newline();
                        } else {
                            print_space();
                        }
                ...
                if (token_text === 'from') {
                    let index = output.lastIndexOf("import");
                    if (index != -1) {
